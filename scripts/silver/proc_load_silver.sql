/*
============================================================
Stored Procedure: Load Silver Layer (Bronze -> Silver_)
============================================================
Script Purpose:
  ...
  - Inserts tranformed and cleaned data from Bronze into Silver tables.
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT
			prd_id,
			REPLACE(SUBSTRING(prd_key, 1, 5), '-', '_') AS cat_id, --  rút gọn để đồng nhất với erp_px_cat_g1v2
